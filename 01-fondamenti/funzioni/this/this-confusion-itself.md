...
- **[[this-itself-illusion]]**: Perché si tende originariamente a credere che `this` faccia riferimento alla funzione in cui giace e come il meccanismo agisce in realtà (generalmente tramite _default binding_).
- **[[this-itself-solutions]]**: Esplorazione delle tattiche inefficaci (come l'abbandono a favore del lexical scope) contrapposte alle strategie strutturalmente corrette (quali il _binding esplicito_ per mezzo di metodi dedicati come `.call()`).
