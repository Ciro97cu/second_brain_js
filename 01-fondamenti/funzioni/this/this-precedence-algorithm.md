...
La priorità garantisce che `new` vinca sempre, mentre il *default binding* perde invariabilmente.
...
foo();
```
Senza un contesto vincolante, `this` è associato al global object (o equivale a `undefined` in *strict mode*).
