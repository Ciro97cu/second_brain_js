...
Il _new binding_ (attivato dall'operatore `new`) rappresenta una delle regole con priorità in assoluto più alta in JavaScript e ha la precedenza totale sull'_implicit binding_.

## Esempio di Precedenza

Quando una funzione viene invocata con l'operatore `new`, viene effettivamente creato un nuovo oggetto e il parametro `this` della funzione vi punta, ignorando totalmente qualsiasi oggetto di contesto che tenterebbe di applicare invece l'_implicit binding_.
