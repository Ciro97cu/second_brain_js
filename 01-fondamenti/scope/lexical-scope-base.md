...
Lo **scope lessicale** (o _static scope_) è il meccanismo mediante il quale JavaScript determina l'accesso alle variabili attraverso lo spazio e i blocchi del codice sorgente. Tale processo avviene durante la fase di lexing, conferendo alle variabili risoluzione in maniera puramente statica.
